...
import 'servicios_admin_model.dart';
export 'servicios_admin_model.dart';

class ServiciosAdminWidget extends StatefulWidget {
  const ServiciosAdminWidget({
    super.key,
  ...
  @override
  State<ServiciosAdminWidget> createState() => _ServiciosAdminWidgetState();
}

class _ServiciosAdminWidgetState extends State<ServiciosAdminWidget> {
  late ServiciosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServiciosAdminModel());
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      'idServicio': serializeParam(
                                        listViewServiciosRecord.reference,
                                        ParamType.DocumentReference,
                                      ),
                                      'precio': serializeParam(
                                        listViewServiciosRecord.precio,
                                        ParamType.int,
                                      ),
