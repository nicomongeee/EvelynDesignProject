...
import 'autenticacion_model.dart';
export 'autenticacion_model.dart';

class AutenticacionWidget extends StatefulWidget {
  const AutenticacionWidget({super.key});

  @override
  State<AutenticacionWidget> createState() => _AutenticacionWidgetState();
}

class _AutenticacionWidgetState extends State<AutenticacionWidget>
    with TickerProviderStateMixin {
  late AutenticacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AutenticacionModel());
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 0.0, 24.0),
                                                  child: Text(
                                                    'Cree una cuenta utilizando el siguiente formulario.',
                                                    textAlign: TextAlign.start,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
