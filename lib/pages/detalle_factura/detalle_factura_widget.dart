...
import 'detalle_factura_model.dart';
export 'detalle_factura_model.dart';

class DetalleFacturaWidget extends StatefulWidget {
  const DetalleFacturaWidget({super.key});
...
class _DetalleFacturaWidgetState extends State<DetalleFacturaWidget> {
  late DetalleFacturaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalleFacturaModel());
