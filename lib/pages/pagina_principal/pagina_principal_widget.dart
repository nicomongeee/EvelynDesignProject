...
import '/pages/sub_menu/sub_menu_widget.dart';
...
class _PaginaPrincipalWidgetState extends State<PaginaPrincipalWidget>
  ...
  void initState() {
    ...
    _model.tabTiendaController = TabController(
      vsync: this,
      length: 3,
      initialIndex: 0,
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              ...
              context.goNamedAuth('Autenticacion', context.mounted);
            },
          ),
          title: Align(
            ...
            child: InkWell(
              ...
              onTap: () async {
                context.pushNamed('PerfilDiseniador');
              },
              child: Text(
                'Evelyn Design',
                  ...
                  children: [
                    Align(
                      ...
                      child: TabBar(
                        ...
                        controller: _model.tabTiendaController,
                        onTap: (i) async {
                          [() async {}, () async {}, () async {}][i]();
                        },
                      ),
                      ...
                      child: TabBarView(
                        ...
                        children: [
                          Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              StreamBuilder<List<ProyectosRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<ProyectosRecord>
                                      listViewProyectosRecordList =
                                      snapshot.data!;
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        listViewProyectosRecordList.length,
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewProyectosRecord =
                                          listViewProyectosRecordList[
                                              listViewIndex];
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                          ...
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              'imagen': serializeParam(
                                                listViewProyectosRecord.imagen,
                                                ParamType.String,
                                              ),
                                              'nombre': serializeParam(
                                                listViewProyectosRecord.nombre,
                                                ParamType.String,
                                              ),
                                              'descripcion': serializeParam(
                                                listViewProyectosRecord
                                                    .descripcion,
                                                ParamType.String,
                                              ),
                                              'idProyecto': serializeParam(
                                                listViewProyectosRecord
                                                    .reference,
